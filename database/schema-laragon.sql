...
-- Utiliser la base de données 'arch'
USE arch;
...
VALUES (
  ...
  '$2a$10$rKZqYvJxKxKxKxKxKxKxKOqYvJxKxKxKxKxKxKxKxKxKxKxKxKxKx',
  'Admin',
  'ARCH EXCELLENCE',
  'admin',
  TRUE,
...
SELECT 'Base de données ARCH créée avec succès pour Laragon!' as Message;
SELECT COUNT(*) as 'Tables créées' FROM information_schema.tables WHERE table_schema = 'arch';
